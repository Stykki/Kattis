...
class runner:
    ...
    def __init__(self, start, end, max_x, max_y, run_map):
        self.binr = 0 # set the first test that we will do (starting at binary)
        
        # making our positions zero based
        ...
        # getting our map and creating a previous visited nodes list
        self.rum_map = run_map
        self.prev_nodes = []

    def base_run(self):
        '''Runs our map, starting with binary (if the starting pos is incorrect
        it will return right away and we can move to the next test)'''
